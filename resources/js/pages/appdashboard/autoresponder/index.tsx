...
import PushAutoresponderProModal from './create';
  ...
  return (
    <AppShell variant="sidebar">
      ...
      <AppContent variant="sidebar" className="overflow-x-hidden">
        ...
        <Head title="Autoresponder" />
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-3xl font-bold">Push Autoresponder <span className="inline-block align-middle text-blue-500" title="Autoresponder Info">&#9432;</span></h1>
            <Dialog>
              <DialogTrigger asChild>
                <Button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded flex items-center gap-2">
                  <span className="text-lg">&#8853;</span> New Push Autoresponder
                </Button>
              </DialogTrigger>
              <PushAutoresponderProModal />
            </Dialog>
          </div>
