...
export default function SegmentationCreate({ users }: Props) {
    ...
    return (
        <AppLayout>
            <Head title="Create Segmentation" />
            
            <div className="space-y-6 p-4">
                {/* Header */}
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Create Segmentation</h1>
                    </div>
                    <nav className="text-sm text-gray-500">
                        <span>Home / Segmentation / Create</span>
                    </nav>
                </div>
