...
interface AdminYouTubeEditProps {
    channel: YouTubeChannel;
    users: User[];
}

export default function AdminYouTubeEdit({ channel, users }: AdminYouTubeEditProps) {
    ...
    useEffect(() => {
        setFormData({
            ...
            logo: channel.logo || '',
            user_id: channel.user_id?.toString() || '',
            status: channel.status || 'Active',
            lp_link: channel.lp_link || ''
        });
    }, [channel]);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.put(`/admin/youtube/${channel.id}`, formData, {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Admin - Edit YouTube Channel" />
            ...
            <div className="flex flex-col gap-6 p-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">Modify the YouTube channel information.</p>
                    </div>
                </div>
