...
import { Header, Footer, PricingPlan, Mathyourself, Forever, SlidebarHome} from '@/components/frontend';
import Monetization from '@/components/frontend/Monetization';
import PricingPlansub from '@/components/frontend/pricingPlansub';
